...
const MOCK_FATURACAO: LinhaFaturacaoCoaching[] = [
    ...
    { idCoaching: 4, dataAula: '2026-04-06', nomeProfessor: 'Diana Rodrigues', fotoProfessorUrl: 'https://randomuser.me/api/portraits/women/65.jpg', nomeAluno: 'Rui Pedro', valorTotal: 120.00, estaPago: true, duracaoMinutos: 120, salaNome: 'Estúdio Principal' },
];
