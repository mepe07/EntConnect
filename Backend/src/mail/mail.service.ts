...
export class MailService {
  ...
  /**
   * Executa a operacao send password reset email.
   * @param to Dados recebidos para a operacao.
   * @param resetLink Dados recebidos para a operacao.
  ...
  /**
   * Executa a operacao get transporter.
   * @returns Resultado da operacao.
   */
