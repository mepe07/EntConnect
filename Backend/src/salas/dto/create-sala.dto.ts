...
/**
 * DTO usado para transportar os dados de Create Sala.
 */
...
export class CreateSalaDto {
  ...
  @ApiProperty({
    example: 1,
    description: 'O ID da modalidade associada à sala',
  })
  ...
  @ApiProperty({
    example: true,
    description: 'Indica se a sala está pronta a ser usada',
  })
  @IsBoolean({
    message: 'A disponibilidade tem de ser verdadeira (true) ou falsa (false).',
  })
  @IsOptional()
  disponivel: boolean;
}
